      ...
      <div className={`${styles.text} d2coding`}>
        ...
        <div className="ml-20">
          ...
          <div className="ml-20">
            ...
            <div>&lt;<span className="red-color">dd</span>&gt;안녕하세요. 사랑과 신뢰를 받는 동료가 되고 싶은 프론트엔드 개발자 강지운입니다. <br /> HTML, CSS, JavaScript, php, React 등의 기술을 다루며, 부족한 실력을 채우기 위해 지속적으로 역량을 강화하고 있습니다. <br /> 저는 첫 직장과 두번째 직장에서 웹퍼블리셔로 근무한 경험이 있습니다. <br /> 하지만 웹을 처음 배울 당시부터 JavaScript의 동적인 웹페이지 구현과 이벤트 핸들링에 매력을 느껴 <br /> 다른 언어보다 JavaScript를 깊게 공부하였고 <br /> 마침내 두번째 직장에서 php로 데이터를 처리하고 사용자 화면에 정적 및 동적으로 표현하는 작업을 수행하며 <br /> 결과적으로 디자인팀에서 개발팀으로 부서 이동 후 프론트엔드 개발자로 새출발하게 되었습니다.&lt;/<span className="red-color">dd</span>&gt;</div>
          </div>
        &lt;/<span className="red-color">dl</span>&gt;
        </div>
